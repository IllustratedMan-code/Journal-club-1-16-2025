...
function o(e2, t2) {
  return function(e3) {
    ...
    var n2 = e3 && ("undefined" != typeof Symbol && e3[Symbol.iterator] || e3["@@iterator"]);
    if (null == n2)
      return;
...
function l(e2, t2) {
  ...
  if (!n2) {
    if (Array.isArray(e2) || (n2 = a(e2)) || t2 && e2 && "number" == typeof e2.length) {
      n2 && (e2 = n2);
...
var p = f("object" == typeof globalThis && globalThis) || f("object" == typeof window && window) || f("object" == typeof self && self) || f("object" == typeof c && c) || function() {
  return this;
...
var b = D(function() {
  ...
  return "String" == x(e2) ? F.call(e2, "") : Object(e2);
} : Object;
var C = function(e2) {
  if (null == e2)
...
"function" != typeof ge.inspectSource && (ge.inspectSource = function(e2) {
  return de.call(e2);
});
...
(ke.exports = function(e2, t2) {
  return Ee[e2] || (Ee[e2] = void 0 !== t2 ? t2 : {});
...
var we = Math.random();
var Be = function(e2) {
  return "Symbol(" + String(void 0 === e2 ? "" : e2) + ")_" + (++Ce + we).toString(36);
};
var Se = ke.exports;
var _e = Be;
var Te = Se("keys");
...
(le.exports = function(e2, t2, n2, r2) {
  ...
  "function" == typeof n2 && ("string" != typeof t2 || Ke(n2, "name") || Ye(n2, "name", t2), (u2 = et(n2)).source || (u2.source = tt.join("string" == typeof t2 ? t2 : ""))), e2 !== Ve ? (i2 ? !a2 && e2[t2] && (o2 = true) : delete e2[t2], o2 ? e2[t2] = n2 : Ye(e2, t2, n2)) : o2 ? e2[t2] = n2 : Xe(t2, n2);
...
var Nt = function(e2, t2) {
  var n2 = qt[Ut(e2)];
  return n2 == Gt || n2 != Zt && ("function" == typeof t2 ? Lt(t2) : !!t2);
};
...
var en = function(e2, t2) {
  ...
  if (n2 = s2 ? Qt : l2 ? Qt[a2] || Xt(a2, {}) : (Qt[a2] || {}).prototype)
    for (r2 in t2) {
      if (i2 = t2[r2], u2 = e2.noTargetGet ? (o2 = Vt(n2, r2)) && o2.value : n2[r2], !Jt(s2 ? r2 : a2 + (l2 ? "." : "#") + r2, e2.forced) && void 0 !== u2) {
...
var hn = function() {
  var e2 = /a/, t2 = /b*/g;
  return cn.call(e2, "a"), cn.call(t2, "a"), 0 !== e2.lastIndex || 0 !== t2.lastIndex;
}();
...
(hn || gn || Dn) && (pn = function(e2) {
  ...
  return o2 && (-1 === (a2 = a2.replace("y", "")).indexOf("g") && (a2 += "g"), c2 = String(e2).slice(i2.lastIndex), i2.lastIndex > 0 && (!i2.multiline || i2.multiline && "\n" !== e2[i2.lastIndex - 1]) && (s2 = "(?: " + s2 + ")", c2 = " " + c2, l2++), n2 = new RegExp("^(?:" + s2 + ")", a2)), gn && (n2 = new RegExp("^" + s2 + "$(?!\\s)", a2)), hn && (t2 = i2.lastIndex), r2 = cn.call(o2 ? n2 : i2, c2), o2 ? r2 ? (r2.input = r2.input.slice(l2), r2[0] = r2[0].slice(l2), r2.index = i2.lastIndex, i2.lastIndex += r2[0].length) : i2.lastIndex = 0 : hn && r2 && (i2.lastIndex = i2.global ? r2.index + r2[0].length : t2), gn && r2 && r2.length > 1 && fn.call(r2[0], n2, function() {
    for (u2 = 1; u2 < arguments.length - 2; u2++)
      void 0 === arguments[u2] && (r2[u2] = void 0);
  }), r2;
});
var dn = pn;
...
var Pn = function(e2) {
  return Tn(jn, e2) && (Rn || "string" == typeof jn[e2]) || (Rn && Tn(zn, e2) ? jn[e2] = zn[e2] : jn[e2] = $n("Symbol." + e2)), jn[e2];
};
var Ln = le.exports;
var Mn = dn;
var Nn = D;
...
var Xn = function(e2, t2, n2, r2) {
  var u2 = Un(e2), i2 = !Nn(function() {
    ...
    var t3 = false, n3 = /a/;
    return "split" === e2 && ((n3 = {}).constructor = {}, n3.constructor[Zn] = function() {
      return n3;
    }, n3.flags = "", n3[u2] = /./[u2]), n3.exec = function() {
      return t3 = true, null;
    }, n3[u2](""), !t3;
  });
  if (!i2 || !o2 || "replace" === e2 && (!Hn || !Qn || Yn) || "split" === e2 && !Kn) {
    ...
    Ln(String.prototype, e2, l2), Ln(Gn, u2, 2 == t2 ? function(e3, t3) {
...
var yr = function(e2, t2, n2, r2, u2, i2) {
  ...
  return void 0 !== u2 && (u2 = ur(u2), s2 = ar), or.call(i2, s2, function(i3, s3) {
    var l2;
    switch (s3.charAt(0)) {
      case "$":
        return "$";
      ...
      default:
        ...
        if (c2 > a2) {
          var f2 = ir(c2 / 10);
          return 0 === f2 ? i3 : f2 <= a2 ? void 0 === r2[f2 - 1] ? s3.charAt(1) : r2[f2 - 1] + s3.charAt(1) : i3;
        }
        l2 = r2[c2 - 1];
    }
    return void 0 === l2 ? "" : l2;
...
pr("replace", 2, function(e2, t2, n2, r2) {
  ...
  return [function(n3, r3) {
    var u3 = dr(this), i3 = null == n3 ? void 0 : n3[e2];
    return void 0 !== i3 ? i3.call(n3, u3, r3) : t2.call(String(u3), n3, r3);
  }, function(e3, r3) {
    if (!u2 && i2 || "string" == typeof r3 && -1 === r3.indexOf(o2)) {
      var a2 = n2(t2, e3, this, r3);
      if (a2.done)
        return a2.value;
    }
    var s2 = hr(e3), l2 = String(this), c2 = "function" == typeof r3;
    c2 || (r3 = String(r3));
    var f2 = s2.global;
    if (f2) {
      var p2 = s2.unicode;
    ...
    for (var g2, d2 = "", v2 = 0, y2 = 0; y2 < h2.length; y2++) {
      ...
      for (var A2 = String(D2[0]), m2 = mr(kr(gr(D2.index), l2.length), 0), k2 = [], E2 = 1; E2 < D2.length; E2++)
        k2.push(void 0 === (g2 = D2[E2]) ? g2 : String(g2));
      var x2 = D2.groups;
      if (c2) {
        var F2 = [A2].concat(k2, m2, l2);
        void 0 !== x2 && F2.push(x2);
...
var Tr = function(e2) {
  var t2;
  return Br(e2) && (void 0 !== (t2 = e2[_r]) ? !!t2 : "RegExp" == Sr(e2));
};
var Or = it;
var Rr = W;
var Ir = g;
...
var Mr = function(e2, t2, n2) {
  var r2, u2;
  return wr && "function" == typeof (r2 = t2.constructor) && r2 !== n2 && Cr(u2 = r2.prototype) && u2 !== n2.prototype && wr(e2, u2), e2;
};
var Nr = W.f;
var Ur = ot.f;
var qr = Tr;
...
if ($r && Lr("RegExp", !tu || nu || Qr(function() {
  ...
  for (ru = function(e2, t2) {
    var n2, r2 = this instanceof ru, u2 = qr(e2), i2 = void 0 === t2;
...
(hu || Du) && au(RegExp.prototype, "toString", function() {
  ...
  return "/" + t2 + "/" + String(void 0 === n2 && e2 instanceof RegExp && !("flags" in fu) ? cu.call(e2) : n2);
}, { unsafe: true });
var gu = ee;
var du = pt;
var vu = C;
...
Xn("match", 1, function(e2, t2, n2) {
  return [function(t3) {
    var n3 = vu(this), r2 = null == t3 ? void 0 : t3[e2];
    return void 0 !== r2 ? r2.call(t3, n3) : new RegExp(t3)[e2](String(n3));
  }, function(e3) {
    ...
    var o2 = u2.unicode;
    u2.lastIndex = 0;
    for (var a2, s2 = [], l2 = 0; null !== (a2 = Au(u2, i2)); ) {
      var c2 = String(a2[0]);
...
wu({ target: "Array", proto: true, forced: _u || !Tu }, { join: function(e2) {
  return Su.call(Bu(this), void 0 === e2 ? "," : e2);
} });
var Ou = function(e2) {
...
var zu = function(e2, t2) {
  ...
  return void 0 === r2 || null == (n2 = Ru(r2)[ju]) ? t2 : Iu(n2);
};
var $u = Xn;
var Pu = Tr;
var Lu = ee;
...
$u("split", 2, function(e2, t2, n2) {
  var r2;
  return r2 = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(e3, n3) {
    var r3 = String(Mu(this)), u2 = void 0 === n3 ? 4294967295 : n3 >>> 0;
    if (0 === u2)
      return [];
    if (void 0 === e3)
      return [r3];
    ...
    var u2 = Mu(this), i2 = null == t3 ? void 0 : t3[e2];
    return void 0 !== i2 ? i2.call(t3, u2, n3) : r2.call(String(u2), t3, n3);
  }, function(e3, u2) {
    var i2 = n2(r2, e3, this, u2, r2 !== t2);
    if (i2.done)
      return i2.value;
    var o2 = Lu(e3), a2 = String(this), s2 = Nu(o2, RegExp), l2 = o2.unicode, c2 = (o2.ignoreCase ? "i" : "") + (o2.multiline ? "m" : "") + (o2.unicode ? "u" : "") + (Hu ? "g" : "y"), f2 = new s2(Hu ? "^(?:" + o2.source + ")" : o2, c2), p2 = void 0 === u2 ? 4294967295 : u2 >>> 0;
    if (0 === p2)
      return [];
    if (0 === a2.length)
      return null === Zu(f2, a2) ? [a2] : [];
    for (var h2 = 0, D2 = 0, g2 = []; D2 < a2.length; ) {
      f2.lastIndex = Hu ? 0 : D2;
      var d2, v2 = Zu(f2, Hu ? a2.slice(D2) : a2);
      if (null === v2 || (d2 = Vu(qu(f2.lastIndex + (Hu ? D2 : 0)), a2.length)) === h2)
        D2 = Uu(a2, D2, l2);
      else {
...
var ri = function(e2) {
  return ti(function() {
    return !!ni[e2]() || "\u200B\x85\u180E" != "\u200B\x85\u180E"[e2]() || ni[e2].name !== e2;
  });
};
var ui = ei.trim;
...
var hi = function(e2, t2) {
  var n2;
  return fi(e2) && ("function" != typeof (n2 = e2.constructor) || n2 !== Array && !fi(n2.prototype) ? ci(n2) && null === (n2 = n2[pi]) && (n2 = void 0) : n2 = void 0), new (void 0 === n2 ? Array : n2)(0 === t2 ? 0 : t2);
};
var Di = ai;
var gi = b;
var di = I;
...
var Ai = [].push;
var mi = function(e2) {
  var t2 = 1 == e2, n2 = 2 == e2, r2 = 3 == e2, u2 = 4 == e2, i2 = 6 == e2, o2 = 7 == e2, a2 = 5 == e2 || i2;
...
var zi = Oi ? Ri : function(e2) {
  ...
  }(t2 = Object(e2), Ii)) ? n2 : ji ? Ri(t2) : "Object" == (r2 = Ri(t2)) && "function" == typeof t2.callee ? "Arguments" : r2;
};
var $i = zi;
...
var no = ee;
var ro = function(e2) {
  return void 0 !== e2 && (Yi.Array === e2 || Xi[Ki] === e2);
};
var uo = pt;
var io = ai;
var oo = function(e2) {
...
Bo && So || (Bo = function(e2) {
  ...
  Oo.now(zo(e2));
} : To && !bo ? (go = (Do = new To()).port2, Do.port1.onmessage = $o, ho = Eo(go.postMessage, go, 1)) : mo.addEventListener && "function" == typeof postMessage && !mo.importScripts && wo && "file:" !== wo.protocol && !ko(Po) ? (ho = Po, mo.addEventListener("message", $o, false)) : ho = "onreadystatechange" in Fo("script") ? function(e2) {
...
var Ra = function(e2, t2, n2) {
  ...
  for (s2 = r2.next; !(l2 = s2.call(r2)).done; ) {
    ...
    if ("object" == typeof a2 && a2 && a2 instanceof so)
      return a2;
  }
  return new so(false);
};
...
var fs = function(e2) {
  var t2;
  return !(!Sa(e2) || "function" != typeof (t2 = e2.then)) && t2;
};
var ps = function(e2, t2) {
  if (!e2.notified) {
    ...
    var n2 = e2.reactions;
    $a(function() {
      for (var r2 = e2.value, u2 = 1 == e2.state, i2 = 0; n2.length > i2; ) {
        var o2, a2, s2, l2 = n2[i2++], c2 = u2 ? l2.ok : l2.fail, f2 = l2.resolve, p2 = l2.reject, h2 = l2.domain;
        try {
          c2 ? (u2 || (2 === e2.rejection && ds(e2), e2.rejection = 1), true === c2 ? o2 = r2 : (h2 && h2.enter(), o2 = c2(r2), h2 && (h2.exit(), s2 = true)), o2 === l2.promise ? p2(ts("Promise-chain cycle")) : (a2 = fs(o2)) ? a2.call(o2, f2, p2) : f2(o2)) : p2(r2);
        } catch (e3) {
          h2 && !s2 && h2.exit(), p2(e3);
        }
      }
...
var hs = function(e2, t2, n2) {
  var r2, u2;
  os ? ((r2 = ns.createEvent("Event")).promise = t2, r2.reason = n2, r2.initEvent(e2, false, true), ka.dispatchEvent(r2)) : r2 = { promise: t2, reason: n2 }, !as && (u2 = ka["on" + e2]) ? u2(r2) : "unhandledrejection" === e2 && La("Unhandled promise rejection", n2);
};
var Ds = function(e2) {
  za.call(ka, function() {
...
if (ls && (es = (Ja = function(e2) {
  ...
  return r2.ok = "function" != typeof e2 || e2, r2.fail = "function" == typeof t2 && t2, r2.domain = Ga ? rs.domain : void 0, n2.parent = true, n2.reactions.push(r2), 0 != n2.state && ps(n2, false), r2.promise;
}, catch: function(e2) {
...
Bs({ target: "Array", proto: true, forced: !zs }, { slice: function(e2, t2) {
  var n2, r2, u2, i2 = Rs(this), o2 = Os(i2.length), a2 = Ts(e2, o2), s2 = Ts(void 0 === t2 ? o2 : t2, o2);
  if (_s(i2) && ("function" != typeof (n2 = i2.constructor) || n2 !== Array && !_s(n2.prototype) ? Ss(n2) && null === (n2 = n2[$s]) && (n2 = void 0) : n2 = void 0, n2 === Array || void 0 === n2))
    return Ps.call(i2, a2, s2);
  for (r2 = new (void 0 === n2 ? Array : n2)(Ls(s2 - a2, 0)), u2 = 0; a2 < s2; a2++, u2++)
...
var ul = Object.create || function(e2, t2) {
  var n2;
  return null !== e2 ? (tl.prototype = Vs(e2), n2 = new tl(), tl.prototype = null, n2[el] = e2) : n2 = rl(), void 0 === t2 ? n2 : Ys(n2, t2);
};
var il = ul;
var ol = W;
...
var Al = dl ? Object.getPrototypeOf : function(e2) {
  return e2 = gl(e2), Dl(e2, vl) ? e2[vl] : "function" == typeof e2.constructor && e2 instanceof e2.constructor ? e2.constructor.prototype : e2 instanceof Object ? yl : null;
};
var ml = D;
var kl = Al;
var El = se;
...
var Gl = function(e2, t2, n2, r2, u2, i2, o2) {
  ...
  }, f2 = t2 + " Iterator", p2 = false, h2 = e2.prototype, D2 = h2[ql] || h2["@@iterator"] || u2 && h2[u2], g2 = !Ul && D2 || c2(u2), d2 = "Array" == t2 && h2.entries || D2;
  if (d2 && (a2 = jl(d2.call(new e2())), Nl !== Object.prototype && a2.next && (jl(a2) !== Nl && (zl ? zl(a2, Nl) : "function" != typeof a2[ql] && Pl(a2, ql, Zl)), $l(a2, f2, true))), "values" == u2 && D2 && "values" !== D2.name && (p2 = true, g2 = function() {
    return D2.call(this);
...
Tc({ target: "Array", proto: true, forced: !Pc }, { splice: function(e2, t2) {
  ...
  if (0 === f2 ? n2 = r2 = 0 : 1 === f2 ? (n2 = 0, r2 = l2 - c2) : (n2 = f2 - 2, r2 = Mc(Lc(Rc(t2), 0), l2 - c2)), l2 + n2 - r2 > 9007199254740991)
...
Xn("search", 1, function(e2, t2, n2) {
  return [function(t3) {
    var n3 = Vc(this), r2 = null == t3 ? void 0 : t3[e2];
    return void 0 !== r2 ? r2.call(t3, n3) : new RegExp(t3)[e2](String(n3));
  }, function(e3) {
    var r2 = n2(t2, e3, this);
    if (r2.done)
    ...
    var a2 = Kc(u2, i2);
    return Yc(u2.lastIndex, o2) || (u2.lastIndex = o2), null === a2 ? -1 : a2.index;
  }];
});
var Xc = en;
var Wc = ei.end;
  ...
  return r(e2, [{ key: "space", value: function(e3) {
    ...
    if (t2) {
      var n2 = t2[0], r2 = function(e4, t3) {
        ...
        return t3.split("\n").map(function(e5) {
          var t4 = e5.match(/^\s+/);
          return null === t4 ? e5 : o(t4, 1)[0].length >= r3.length ? e5.slice(r3.length) : e5;
        }).join("\n");
      }(n2, t2[3] || "");
    ...
    if (t2) {
      var n2 = { type: "html", raw: t2[0], pre: !this.options.sanitizer && ("pre" === t2[1] || "script" === t2[1] || "style" === t2[1]), text: t2[0] };
    ...
    if (t2) {
      ...
      if (!this.options.pedantic && /^</.test(n2)) {
        ...
        if (u2 > -1) {
          var i2 = (0 === t2[0].indexOf("!") ? 5 : 4) + t2[1].length + u2;
    ...
    var n2 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "", r2 = this.rules.inline.emStrong.lDelim.exec(e3);
    if (r2 && (!r2[3] || !n2.match(/(?:[0-9A-Za-z\xAA\xB2\xB3\xB5\xB9\xBA\xBC-\xBE\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0560-\u0588\u05D0-\u05EA\u05EF-\u05F2\u0620-\u064A\u0660-\u0669\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07C0-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u08A0-\u08B4\u08B6-\u08C7\u0904-\u0939\u093D\u0950\u0958-\u0961\u0966-\u096F\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09E6-\u09F1\u09F4-\u09F9\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A66-\u0A6F\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AE6-\u0AEF\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B66-\u0B6F\u0B71-\u0B77\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0BE6-\u0BF2\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C60\u0C61\u0C66-\u0C6F\u0C78-\u0C7E\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDE\u0CE0\u0CE1\u0CE6-\u0CEF\u0CF1\u0CF2\u0D04-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D58-\u0D61\u0D66-\u0D78\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0DE6-\u0DEF\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E50-\u0E59\u0E81\u0E82\u0E84\u0E86-\u0E8A\u0E8C-\u0EA3\u0EA5\u0EA7-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0ED0-\u0ED9\u0EDC-\u0EDF\u0F00\u0F20-\u0F33\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F-\u1049\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u1090-\u1099\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1369-\u137C\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16EE-\u16F8\u1700-\u170C\u170E-\u1711\u1720-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u17E0-\u17E9\u17F0-\u17F9\u1810-\u1819\u1820-\u1878\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1946-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u19D0-\u19DA\u1A00-\u1A16\u1A20-\u1A54\u1A80-\u1A89\u1A90-\u1A99\u1AA7\u1B05-\u1B33\u1B45-\u1B4B\u1B50-\u1B59\u1B83-\u1BA0\u1BAE-\u1BE5\u1C00-\u1C23\u1C40-\u1C49\u1C4D-\u1C7D\u1C80-\u1C88\u1C90-\u1CBA\u1CBD-\u1CBF\u1CE9-\u1CEC\u1CEE-\u1CF3\u1CF5\u1CF6\u1CFA\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2070\u2071\u2074-\u2079\u207F-\u2089\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2150-\u2189\u2460-\u249B\u24EA-\u24FF\u2776-\u2793\u2C00-\u2C2E\u2C30-\u2C5E\u2C60-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2CFD\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005-\u3007\u3021-\u3029\u3031-\u3035\u3038-\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312F\u3131-\u318E\u3192-\u3195\u31A0-\u31BF\u31F0-\u31FF\u3220-\u3229\u3248-\u324F\u3251-\u325F\u3280-\u3289\u32B1-\u32BF\u3400-\u4DBF\u4E00-\u9FFC\uA000-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6EF\uA717-\uA71F\uA722-\uA788\uA78B-\uA7BF\uA7C2-\uA7CA\uA7F5-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA830-\uA835\uA840-\uA873\uA882-\uA8B3\uA8D0-\uA8D9\uA8F2-\uA8F7\uA8FB\uA8FD\uA8FE\uA900-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF-\uA9D9\uA9E0-\uA9E4\uA9E6-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA50-\uAA59\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB69\uAB70-\uABE2\uABF0-\uABF9\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF10-\uFF19\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDD07-\uDD33\uDD40-\uDD78\uDD8A\uDD8B\uDE80-\uDE9C\uDEA0-\uDED0\uDEE1-\uDEFB\uDF00-\uDF23\uDF2D-\uDF4A\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF\uDFD1-\uDFD5]|\uD801[\uDC00-\uDC9D\uDCA0-\uDCA9\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC58-\uDC76\uDC79-\uDC9E\uDCA7-\uDCAF\uDCE0-\uDCF2\uDCF4\uDCF5\uDCFB-\uDD1B\uDD20-\uDD39\uDD80-\uDDB7\uDDBC-\uDDCF\uDDD2-\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE35\uDE40-\uDE48\uDE60-\uDE7E\uDE80-\uDE9F\uDEC0-\uDEC7\uDEC9-\uDEE4\uDEEB-\uDEEF\uDF00-\uDF35\uDF40-\uDF55\uDF58-\uDF72\uDF78-\uDF91\uDFA9-\uDFAF]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2\uDCFA-\uDD23\uDD30-\uDD39\uDE60-\uDE7E\uDE80-\uDEA9\uDEB0\uDEB1\uDF00-\uDF27\uDF30-\uDF45\uDF51-\uDF54\uDFB0-\uDFCB\uDFE0-\uDFF6]|\uD804[\uDC03-\uDC37\uDC52-\uDC6F\uDC83-\uDCAF\uDCD0-\uDCE8\uDCF0-\uDCF9\uDD03-\uDD26\uDD36-\uDD3F\uDD44\uDD47\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDD0-\uDDDA\uDDDC\uDDE1-\uDDF4\uDE00-\uDE11\uDE13-\uDE2B\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDEF0-\uDEF9\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC50-\uDC59\uDC5F-\uDC61\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDCD0-\uDCD9\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE50-\uDE59\uDE80-\uDEAA\uDEB8\uDEC0-\uDEC9\uDF00-\uDF1A\uDF30-\uDF3B]|\uD806[\uDC00-\uDC2B\uDCA0-\uDCF2\uDCFF-\uDD06\uDD09\uDD0C-\uDD13\uDD15\uDD16\uDD18-\uDD2F\uDD3F\uDD41\uDD50-\uDD59\uDDA0-\uDDA7\uDDAA-\uDDD0\uDDE1\uDDE3\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE89\uDE9D\uDEC0-\uDEF8]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC50-\uDC6C\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46\uDD50-\uDD59\uDD60-\uDD65\uDD67\uDD68\uDD6A-\uDD89\uDD98\uDDA0-\uDDA9\uDEE0-\uDEF2\uDFB0\uDFC0-\uDFD4]|\uD808[\uDC00-\uDF99]|\uD809[\uDC00-\uDC6E\uDC80-\uDD43]|[\uD80C\uD81C-\uD820\uD822\uD840-\uD868\uD86A-\uD86C\uD86F-\uD872\uD874-\uD879\uD880-\uD883][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2E]|\uD811[\uDC00-\uDE46]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE60-\uDE69\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF50-\uDF59\uDF5B-\uDF61\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDE40-\uDE96\uDF00-\uDF4A\uDF50\uDF93-\uDF9F\uDFE0\uDFE1\uDFE3]|\uD821[\uDC00-\uDFF7]|\uD823[\uDC00-\uDCD5\uDD00-\uDD08]|\uD82C[\uDC00-\uDD1E\uDD50-\uDD52\uDD64-\uDD67\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD834[\uDEE0-\uDEF3\uDF60-\uDF78]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB\uDFCE-\uDFFF]|\uD838[\uDD00-\uDD2C\uDD37-\uDD3D\uDD40-\uDD49\uDD4E\uDEC0-\uDEEB\uDEF0-\uDEF9]|\uD83A[\uDC00-\uDCC4\uDCC7-\uDCCF\uDD00-\uDD43\uDD4B\uDD50-\uDD59]|\uD83B[\uDC71-\uDCAB\uDCAD-\uDCAF\uDCB1-\uDCB4\uDD01-\uDD2D\uDD2F-\uDD3D\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD83C[\uDD00-\uDD0C]|\uD83E[\uDFF0-\uDFF9]|\uD869[\uDC00-\uDEDD\uDF00-\uDFFF]|\uD86D[\uDC00-\uDF34\uDF40-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEA1\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A])/))) {
      ...
      if (!u2 || u2 && ("" === n2 || this.rules.inline.punctuation.exec(n2))) {
        ...
        for (c2.lastIndex = 0, t2 = t2.slice(-1 * e3.length + a2); null != (r2 = c2.exec(t2)); )
    ...
    if (n2 = this.rules.inline.url.exec(e3)) {
      ...
      if ("@" === n2[2])
        ...
        r2 = xf(n2[0]), u2 = "www." === n2[1] ? "http://" + r2 : r2;
      }
...
var Qf = function() {
  ...
  return r(e2, [{ key: "lex", value: function(e3) {
    ...
    var t2, n2, r2, u2, i2 = this, o2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
    for (this.options.pedantic && (e3 = e3.replace(/^ +$/gm, "")); e3; )
      if (!(this.options.extensions && this.options.extensions.block && this.options.extensions.block.some(function(n3) {
        ...
        if (t2 = this.tokenizer.space(e3))
          e3 = e3.substring(t2.raw.length), 1 === t2.raw.length && o2.length > 0 ? o2[o2.length - 1].raw += "\n" : o2.push(t2);
        else if (t2 = this.tokenizer.code(e3))
          e3 = e3.substring(t2.raw.length), !(n2 = o2[o2.length - 1]) || "paragraph" !== n2.type && "text" !== n2.type ? o2.push(t2) : (n2.raw += "\n" + t2.raw, n2.text += "\n" + t2.text, this.inlineQueue[this.inlineQueue.length - 1].src = n2.text);
          ...
          e3 = e3.substring(t2.raw.length), !(n2 = o2[o2.length - 1]) || "paragraph" !== n2.type && "text" !== n2.type ? this.tokens.links[t2.tag] || (this.tokens.links[t2.tag] = { href: t2.href, title: t2.title }) : (n2.raw += "\n" + t2.raw, n2.text += "\n" + t2.raw, this.inlineQueue[this.inlineQueue.length - 1].src = n2.text);
    ...
    var t2, n2, r2, u2, i2, o2, a2 = this, s2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], l2 = e3;
    if (this.tokens.links) {
      var c2 = Object.keys(this.tokens.links);
      if (c2.length > 0)
        for (; null != (u2 = this.tokenizer.rules.inline.reflinkSearch.exec(l2)); )
    ...
    for (; null != (u2 = this.tokenizer.rules.inline.blockSkip.exec(l2)); )
      l2 = l2.slice(0, u2.index) + "[" + Mf("a", u2[0].length - 2) + "]" + l2.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
    for (; null != (u2 = this.tokenizer.rules.inline.escapedEmSt.exec(l2)); )
    ...
    for (; e3; )
      if (i2 || (o2 = ""), i2 = false, !(this.options.extensions && this.options.extensions.inline && this.options.extensions.inline.some(function(n3) {
        ...
        if (t2 = this.tokenizer.escape(e3))
          ...
          e3 = e3.substring(t2.raw.length), (n2 = s2[s2.length - 1]) && "text" === t2.type && "text" === n2.type ? (n2.raw += t2.raw, n2.text += t2.text) : s2.push(t2);
          ...
          if (r2 = e3, this.options.extensions && this.options.extensions.startInline && function() {
            ...
            e3 = e3.substring(t2.raw.length), "_" !== t2.raw.slice(-1) && (o2 = t2.raw.slice(-1)), i2 = true, (n2 = s2[s2.length - 1]) && "text" === n2.type ? (n2.raw += t2.raw, n2.text += t2.text) : s2.push(t2);
          else if (e3) {
...
var Vf = function() {
  ...
  return r(e2, [{ key: "code", value: function(e3, t2, n2) {
    ...
    if (null === (e3 = _f(this.options.sanitize, this.options.baseUrl, e3)))
      return n2;
    var r2 = '<a href="' + xf(e3) + '"';
...
var Kf = function() {
  ...
  return r(e2, [{ key: "serialize", value: function(e3) {
    ...
    var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n2 = this.serialize(e3);
...
var Xf = function() {
  ...
  return r(e2, [{ key: "parse", value: function(e3) {
    var t2, n2, r2, u2, i2, o2, a2, s2, l2, c2, f2, p2, h2, D2, g2, d2, v2, y2, A2, m2 = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], k2 = "", E2 = e3.length;
    for (t2 = 0; t2 < E2; t2++)
      if (c2 = e3[t2], !(this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[c2.type]) || false === (A2 = this.options.extensions.renderers[c2.type].call({ parser: this }, c2)) && ["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(c2.type))
        switch (c2.type) {
          case "space":
            continue;
          case "hr":
          ...
          case "list":
            for (f2 = c2.ordered, p2 = c2.start, h2 = c2.loose, u2 = c2.items.length, l2 = "", n2 = 0; n2 < u2; n2++)
              d2 = (g2 = c2.items[n2]).checked, v2 = g2.task, D2 = "", g2.task && (y2 = this.renderer.checkbox(d2), h2 ? g2.tokens.length > 0 && "paragraph" === g2.tokens[0].type ? (g2.tokens[0].text = y2 + " " + g2.tokens[0].text, g2.tokens[0].tokens && g2.tokens[0].tokens.length > 0 && "text" === g2.tokens[0].tokens[0].type && (g2.tokens[0].tokens[0].text = y2 + " " + g2.tokens[0].tokens[0].text)) : g2.tokens.unshift({ type: "text", text: y2 }) : D2 += y2), D2 += this.parse(g2.tokens, h2), l2 += this.renderer.listitem(D2, v2, d2);
          ...
          case "paragraph":
            ...
            continue;
          case "text":
            for (l2 = c2.tokens ? this.parseInline(c2.tokens) : c2.text; t2 + 1 < E2 && "text" === e3[t2 + 1].type; )
    ...
    for (n2 = 0; n2 < o2; n2++)
      if (r2 = e3[n2], !(this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[r2.type]) || false === (u2 = this.options.extensions.renderers[r2.type].call({ parser: this }, r2)) && ["escape", "html", "link", "image", "strong", "em", "codespan", "br", "del", "text"].includes(r2.type))
        switch (r2.type) {
          case "escape":
            i2 += t2.text(r2.text);
            break;
...
function Wf(e2, t2, n2) {
  ...
  if ("function" == typeof t2 && (n2 = t2, t2 = null), Lf(t2 = zf({}, Wf.defaults, t2 || {})), n2) {
    ...
    return Wf.walkTokens(r2, function(e3) {
      "code" === e3.type && (o2++, setTimeout(function() {
        u2(e3.text, e3.lang, function(t3, n3) {
          if (t3)
            return i2(t3);
          null != n3 && n3 !== e3.text && (e3.text = n3, e3.escaped = true), 0 === --o2 && i2();
        });
      }, 0));
    }), void (0 === o2 && i2());
  }
    ...
    if (e3.extensions && (r2 = true, e3.extensions.forEach(function(e4) {
      ...
      if (e4.renderer) {
        ...
        i2.renderers[e4.name] = t4 ? function() {
          ...
          return false === i3 && (i3 = t4.apply(this, r3)), i3;
        } : e4.renderer;
      }
      if (e4.tokenizer) {
        if (!e4.level || "block" !== e4.level && "inline" !== e4.level)
          throw new Error("extension level must be 'block' or 'inline'");
        i2[e4.level] ? i2[e4.level].unshift(e4.tokenizer) : i2[e4.level] = [e4.tokenizer], e4.start && ("block" === e4.level ? i2.startBlock ? i2.startBlock.push(e4.start) : i2.startBlock = [e4.start] : "inline" === e4.level && (i2.startInline ? i2.startInline.push(e4.start) : i2.startInline = [e4.start]));
      }
      ...
      var t4 = Wf.defaults.renderer || new Vf(), n3 = function(n4) {
        ...
        t4[n4] = function() {
          ...
          return false === a2 && (a2 = r4.apply(t4, i3)), a2;
        };
      };
...
function markdown_esm_default() {
  ...
  function a2(e2, t3) {
    ...
    return 2 === n3.length && (e2 = n3[0] + '<aside class="notes">' + Wf(n3[1].trim()) + "</aside>"), '<script type="text/template">' + (e2 = e2.replace(/<\/script>/g, "__SCRIPT_END__")) + "<\/script>";
  }
  function s2(e2, t3) {
    t3 = o2(t3);
      ...
      [].slice.call(e2.querySelectorAll("section[data-markdown]:not([data-markdown-parsed])")).forEach(function(e3, t4) {
        e3.getAttribute("data-markdown").length ? u2.push(function(e4) {
          return new Promise(function(t5, n3) {
            ...
            null != i2 && "" != i2 && r3.overrideMimeType("text/html; charset=" + i2), r3.onreadystatechange = function(e5, r4) {
              4 === r4.readyState && (r4.status >= 200 && r4.status < 300 || 0 === r4.status ? t5(r4, u3) : n3(r4, u3));
      ...
      for (var i2 = t3, o3 = 0; o3 < t3.childNodes.length; o3++) {
        ...
        if (o3 > 0)
          for (var s3 = o3 - 1; s3 >= 0; ) {
            ...
            if ("function" == typeof l3.setAttribute && "BR" != l3.tagName) {
              i2 = l3;
              break;
            }
            s3 -= 1;
        ...
        var p3 = e2;
        "section" == a3.nodeName && (p3 = a3, i2 = a3), "function" != typeof a3.setAttribute && a3.nodeType != Node.COMMENT_NODE || f2(p3, a3, i2, r3, u2);
      }
    t3.nodeType == Node.COMMENT_NODE && 0 == c2(t3, n3, r3) && c2(t3, e2, u2);
  }
  function p2() {
...
// dep:reveal__js_plugin_markdown_markdown__esm
var reveal_js_plugin_markdown_markdown_esm_default = markdown_esm_default;
export {
  reveal_js_plugin_markdown_markdown_esm_default as default
};
//# sourceMappingURL=reveal__js_plugin_markdown_markdown__esm.js.map
