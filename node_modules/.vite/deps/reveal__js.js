...
var E = class {
  ...
  load(e2, i2 = {}) {
    e2.style.display = this.Reveal.getConfig().display, t(e2, "img[data-src], video[data-src], audio[data-src], iframe[data-src]").forEach((e3) => {
      ...
      }), v && "VIDEO" === e3.tagName && e3.setAttribute("playsinline", ""), i3 > 0 && e3.load();
    });
...
var A = class {
  ...
  sync(e2) {
    ...
    if (n2) {
      const t3 = S(n2);
      t3 && 0 !== t3.a && ("string" == typeof (r2 = n2) && (r2 = S(r2)), (r2 ? (299 * r2.r + 587 * r2.g + 114 * r2.b) / 1e3 : null) < 128 ? e2.classList.add("has-dark-background") : e2.classList.add("has-light-background"));
    }
    var r2;
  }
  update(e2 = false) {
...
var x = class {
  ...
  run(e2, t2) {
    ...
    if (e2.hasAttribute("data-auto-animate") && t2.hasAttribute("data-auto-animate") && e2.getAttribute("data-auto-animate-id") === t2.getAttribute("data-auto-animate-id") && !(s2 > a2 ? t2 : e2).hasAttribute("data-auto-animate-restart")) {
      ...
      if ("false" !== t2.dataset.autoAnimateUnmatched && true === this.Reveal.getConfig().autoAnimateUnmatched) {
  ...
  autoAnimateElements(e2, t2, i2, s2, a2) {
    ...
    if (t2.classList.contains("fragment") && (delete o2.styles.opacity, e2.classList.contains("fragment"))) {
      (e2.className.match(L) || [""])[0] === (t2.className.match(L) || [""])[0] && "forward" === s2.slideDirection && t2.classList.add("visible", "disabled");
    }
  ...
  getAutoAnimatableProperties(e2, t2, i2) {
    ...
    return (i2.styles || s2.autoAnimateStyles).forEach((t3) => {
      let i3;
      "string" == typeof t3 && (t3 = { property: t3 }), i3 = void 0 !== t3.from && "from" === e2 ? { value: t3.from, explicitValue: true } : void 0 !== t3.to && "to" === e2 ? { value: t3.to, explicitValue: true } : n2[t3.property], "" !== i3 && (a2.styles[t3.property] = i3);
    }), a2;
  }
...
var P = class {
  ...
  update(e2, t2) {
    ...
    if (s2 && this.Reveal.getConfig().fragments && (t2 = t2 || this.sort(s2.querySelectorAll(".fragment"))).length) {
      ...
      }), e2 = "number" == typeof e2 ? e2 : -1, e2 = Math.max(Math.min(e2, a2), -1), s2.setAttribute("data-fragment", e2);
    }
    return i2;
  }
...
var M = class {
  ...
  onDocumentKeyDown(e2) {
    ...
    false === h2 && (h2 = true, 80 === i2 || 33 === i2 ? this.Reveal.prev({ skipFragments: e2.altKey }) : 78 === i2 || 34 === i2 ? this.Reveal.next({ skipFragments: e2.altKey }) : 72 === i2 || 37 === i2 ? e2.shiftKey ? this.Reveal.slide(0) : !this.Reveal.overview.isActive() && c2 ? this.Reveal.prev({ skipFragments: e2.altKey }) : this.Reveal.left({ skipFragments: e2.altKey }) : 76 === i2 || 39 === i2 ? e2.shiftKey ? this.Reveal.slide(this.Reveal.getHorizontalSlides().length - 1) : !this.Reveal.overview.isActive() && c2 ? this.Reveal.next({ skipFragments: e2.altKey }) : this.Reveal.right({ skipFragments: e2.altKey }) : 75 === i2 || 38 === i2 ? e2.shiftKey ? this.Reveal.slide(void 0, 0) : !this.Reveal.overview.isActive() && c2 ? this.Reveal.prev({ skipFragments: e2.altKey }) : this.Reveal.up({ skipFragments: e2.altKey }) : 74 === i2 || 40 === i2 ? e2.shiftKey ? this.Reveal.slide(void 0, Number.MAX_VALUE) : !this.Reveal.overview.isActive() && c2 ? this.Reveal.next({ skipFragments: e2.altKey }) : this.Reveal.down({ skipFragments: e2.altKey }) : 36 === i2 ? this.Reveal.slide(0) : 35 === i2 ? this.Reveal.slide(this.Reveal.getHorizontalSlides().length - 1) : 32 === i2 ? (this.Reveal.overview.isActive() && this.Reveal.overview.deactivate(), e2.shiftKey ? this.Reveal.prev({ skipFragments: e2.altKey }) : this.Reveal.next({ skipFragments: e2.altKey })) : 58 === i2 || 59 === i2 || 66 === i2 || 86 === i2 || 190 === i2 || 191 === i2 ? this.Reveal.togglePause() : 70 === i2 ? ((e3) => {
      ...
      t3 && t3.apply(e3);
    })(t2.embedded ? this.Reveal.getViewportElement() : document.documentElement) : 65 === i2 ? t2.autoSlideStoppable && this.Reveal.toggleAutoSlide(s2) : h2 = false), h2 ? e2.preventDefault && e2.preventDefault() : 27 !== i2 && 79 !== i2 || (false === this.Reveal.closeOverlay() && this.Reveal.overview.toggle(), e2.preventDefault && e2.preventDefault()), this.Reveal.cueAutoSlide();
  }
};
var D = class {
  constructor(e2) {
  ...
  load(e2, t2) {
    return this.state = "loading", e2.forEach(this.registerPlugin.bind(this)), new Promise((e3) => {
      ...
      if (t2.forEach((e4) => {
        ...
        i2.forEach((e4) => {
          "string" == typeof e4.id ? (this.registerPlugin(e4), t3(e4)) : "string" == typeof e4.src ? z(e4.src, () => t3(e4)) : (console.warn("Unrecognized plugin format", e4), t3());
        });
      } else
  ...
  async setupPDF() {
    ...
    i2.forEach(function(i3, a3) {
      if (false === i3.classList.contains("stack")) {
        ...
        p2 = Math.min(p2, e2.pdfMaxPagesPerSlide), (1 === p2 && e2.center || i3.classList.contains("center")) && (c3 = Math.max((r2 - v3) / 2, 0));
        ...
        if (g2.push(m2), m2.className = "pdf-page", m2.style.height = (r2 + e2.pdfPageHeightOffset) * p2 + "px", h2 && (m2.style.background = h2), m2.appendChild(i3), i3.style.left = l2 + "px", i3.style.top = c3 + "px", i3.style.width = o2 + "px", this.Reveal.slideContent.layout(i3), i3.slideBackgroundElement && m2.insertBefore(i3.slideBackgroundElement, i3), e2.showNotes) {
          ...
          if (t2) {
            ...
            a4.classList.add("speaker-notes"), a4.classList.add("speaker-notes-pdf"), a4.setAttribute("data-layout", s3), a4.innerHTML = t2, "separate-page" === s3 ? g2.push(a4) : (a4.style.left = i4 + "px", a4.style.bottom = i4 + "px", a4.style.width = n2 - 2 * i4 + "px", m2.appendChild(a4));
          }
        }
        if (s2) {
...
function V(n2, l2) {
  ...
  function ue(e2) {
    ...
    return y2 = { ...K, ...y2, ...l2, ...e2, ...d() }, ge(), window.addEventListener("load", qe, false), oe.load(y2.plugins, y2.dependencies).then(ve), new Promise((e3) => h2.on("ready", e3));
  }
  function ge() {
    true === y2.embedded ? V2.viewport = r(n2, ".reveal-viewport") || n2 : (V2.viewport = document.body, document.documentElement.classList.add("reveal-full-page")), V2.viewport.classList.add("reveal-viewport");
  }
  function ve() {
    ...
    }, 1), le.isPrintingPDF() && (ke(), "complete" === document.readyState ? le.setupPDF() : window.addEventListener("load", () => {
      le.setupPDF();
    }));
  }
  function pe() {
  ...
  function we() {
    setInterval(() => {
      0 === V2.wrapper.scrollTop && 0 === V2.wrapper.scrollLeft || (V2.wrapper.scrollTop = 0, V2.wrapper.scrollLeft = 0);
    }, 1e3);
  }
  function Ee() {
  ...
  function Se(t2) {
    const s2 = { ...y2 };
    if ("object" == typeof t2 && e(y2, t2), false === h2.isReady())
      return;
    const a2 = V2.wrapper.querySelectorAll(".slides section").length;
    V2.wrapper.classList.remove(s2.transition), V2.wrapper.classList.add(y2.transition), V2.wrapper.setAttribute("data-transition-speed", y2.transitionSpeed), V2.wrapper.setAttribute("data-background-transition", y2.backgroundTransition), V2.viewport.style.setProperty("--slide-width", y2.width + "px"), V2.viewport.style.setProperty("--slide-height", y2.height + "px"), y2.shuffle && st(), i(V2.wrapper, "embedded", y2.embedded), i(V2.wrapper, "rtl", y2.rtl), i(V2.wrapper, "center", y2.center), false === y2.pause && Ye(), y2.previewLinks ? (De(), Ie("[data-preview-link=false]")) : (Ie(), De("[data-preview-link]:not([data-preview-link=false])")), Z.reset(), b2 && (b2.destroy(), b2 = null), a2 > 1 && y2.autoSlide && y2.autoSlideStoppable && (b2 = new W(V2.wrapper, () => Math.min(Math.max((Date.now() - Y) / j2, 0), 1)), b2.on("click", Ot), _ = false), "default" !== y2.navigationMode ? V2.wrapper.setAttribute("data-navigation-mode", y2.navigationMode) : V2.wrapper.removeAttribute("data-navigation-mode"), he.configure(y2, s2), de.configure(y2, s2), re.configure(y2, s2), ae.configure(y2, s2), ne.configure(y2, s2), ie.configure(y2, s2), ee.configure(y2, s2), Q.configure(y2, s2), et();
  }
  function Ae() {
  ...
  function Pe(e2) {
    "string" == typeof e2.layout && (z2.layout = e2.layout), "string" == typeof e2.overview && (z2.overview = e2.overview), z2.layout ? a(V2.slides, z2.layout + " " + z2.overview) : a(V2.slides, z2.overview);
  }
  ...
  function Fe(e2) {
    "boolean" == typeof e2 ? e2 ? ze() : He() : V2.overlay ? He() : ze();
  }
  function ze() {
    if (y2.help) {
  ...
  function qe() {
    if (V2.wrapper && !le.isPrintingPDF()) {
      if (!y2.disableLayout) {
        ...
        const e2 = Oe(), t2 = C2;
        Be(y2.width, y2.height), V2.slides.style.width = e2.width + "px", V2.slides.style.height = e2.height + "px", C2 = Math.min(e2.presentationWidth / e2.width, e2.presentationHeight / e2.height), C2 = Math.max(C2, y2.minScale), C2 = Math.min(C2, y2.maxScale), 1 === C2 ? (V2.slides.style.zoom = "", V2.slides.style.left = "", V2.slides.style.top = "", V2.slides.style.bottom = "", V2.slides.style.right = "", Pe({ layout: "" })) : C2 > 1 && f && window.devicePixelRatio < 2 ? (V2.slides.style.zoom = C2, V2.slides.style.left = "", V2.slides.style.top = "", V2.slides.style.bottom = "", V2.slides.style.right = "", Pe({ layout: "" })) : (V2.slides.style.zoom = "", V2.slides.style.left = "50%", V2.slides.style.top = "50%", V2.slides.style.bottom = "auto", V2.slides.style.right = "auto", Pe({ layout: "translate(-50%, -50%) scale(" + C2 + ")" }));
        const i2 = Array.from(V2.wrapper.querySelectorAll(".slides section"));
        for (let t3 = 0, s2 = i2.length; t3 < s2; t3++) {
          const s3 = i2[t3];
          "none" !== s3.style.display && (y2.center || s3.classList.contains("center") ? s3.classList.contains("stack") ? s3.style.top = 0 : s3.style.top = Math.max((e2.height - s3.scrollHeight) / 2, 0) + "px" : s3.style.top = "");
        }
  ...
  function Oe(e2, t2) {
    ...
    return i2.presentationWidth -= i2.presentationWidth * y2.margin, i2.presentationHeight -= i2.presentationHeight * y2.margin, "string" == typeof i2.width && /%$/.test(i2.width) && (i2.width = parseInt(i2.width, 10) / 100 * i2.presentationWidth), "string" == typeof i2.height && /%$/.test(i2.height) && (i2.height = parseInt(i2.height, 10) / 100 * i2.presentationHeight), i2;
  }
  function Ue(e2, t2) {
  ...
  function Xe() {
    if (y2.pause) {
      ...
      St(), V2.wrapper.classList.add("paused"), false === e2 && Ne({ type: "paused" });
    }
  }
  function Ye() {
    const e2 = V2.wrapper.classList.contains("paused");
  ...
  function et() {
    ke(), Ae(), qe(), j2 = y2.autoSlide, Rt(), G.create(), se.writeURL(), ee.sortAll(), ae.update(), ne.update(), nt(), he.update(), he.updateVisibility(), G.update(true), Q.update(), J.formatEmbeddedContent(), false === y2.autoPlayMedia ? J.stopEmbeddedContent(m2, { unloadIframes: false }) : J.startEmbeddedContent(m2), te.isActive() && te.layout();
  }
  function tt(e2 = m2) {
  ...
  function rt({ includeFragments: e2 = false } = {}) {
    ...
    if (y2.loop && (t2.length > 1 && (s2.left = true, s2.right = true), i2.length > 1 && (s2.up = true, s2.down = true)), t2.length > 1 && "linear" === y2.navigationMode && (s2.right = s2.right || s2.down, s2.left = s2.left || s2.up), true === e2) {
  ...
  function yt(e2, t2) {
    let i2 = "number" == typeof e2 ? bt(e2, t2) : e2;
    if (i2)
  ...
  function Et(e2) {
    if ("object" == typeof e2) {
      ...
      "boolean" == typeof t2 && t2 !== Je() && _e(t2), "boolean" == typeof i2 && i2 !== te.isActive() && te.toggle(i2);
    }
  }
  function Rt() {
    if (St(), m2 && false !== y2.autoSlide) {
      ...
      i2 ? j2 = parseInt(i2, 10) : a2 ? j2 = parseInt(a2, 10) : s2 ? j2 = parseInt(s2, 10) : (j2 = y2.autoSlide, 0 === m2.querySelectorAll(".fragment").length && t(m2, "video, audio").forEach((e3) => {
        e3.hasAttribute("data-autoplay") && j2 && 1e3 * e3.duration / e3.playbackRate > j2 && (j2 = 1e3 * e3.duration / e3.playbackRate + 1e3);
      })), !j2 || _ || Je() || te.isActive() || je() && !ee.availableRoutes().next && true !== y2.loop || (X = setTimeout(() => {
        "function" == typeof y2.autoSlideMethod ? y2.autoSlideMethod() : Mt(), Rt();
      }, j2), Y = Date.now()), b2 && b2.setPlaying(-1 !== X);
    }
  }
  function St() {
    clearTimeout(X), X = -1;
  ...
  function Lt({ skipFragments: e2 = false } = {}) {
    S2.hasNavigatedHorizontally = true, y2.rtl ? (te.isActive() || e2 || false === ee.next()) && rt().left && Ge(u2 + 1, "grid" === y2.navigationMode ? g2 : void 0) : (te.isActive() || e2 || false === ee.prev()) && rt().left && Ge(u2 - 1, "grid" === y2.navigationMode ? g2 : void 0);
  }
  function Ct({ skipFragments: e2 = false } = {}) {
    S2.hasNavigatedHorizontally = true, y2.rtl ? (te.isActive() || e2 || false === ee.prev()) && rt().right && Ge(u2 - 1, "grid" === y2.navigationMode ? g2 : void 0) : (te.isActive() || e2 || false === ee.next()) && rt().right && Ge(u2 + 1, "grid" === y2.navigationMode ? g2 : void 0);
  }
  function xt({ skipFragments: e2 = false } = {}) {
    (te.isActive() || e2 || false === ee.prev()) && rt().up && Ge(u2, g2 - 1);
  }
  function Pt({ skipFragments: e2 = false } = {}) {
    S2.hasNavigatedVertically = true, (te.isActive() || e2 || false === ee.next()) && rt().down && Ge(u2, g2 + 1);
  }
  ...
  function Mt({ skipFragments: e2 = false } = {}) {
    if (S2.hasNavigatedHorizontally = true, S2.hasNavigatedVertically = true, e2 || false === ee.next()) {
      let t2 = rt();
  ...
  function Tt(e2) {
    "running" === $2 && /section/gi.test(e2.target.nodeName) && ($2 = "idle", Ne({ type: "slidetransitionend", data: { indexh: u2, indexv: g2, previousSlide: p2, currentSlide: m2 } }));
  }
  function Ft(e2) {
  ...
  function Ot(e2) {
    je() && false === y2.loop ? (Ge(0, 0), kt()) : _ ? kt() : At();
  }
  ...
  return e(h2, { ...Ut, announceStatus: be, getStatusText: ye, print: le, focus: de, progress: ne, controls: ae, location: se, overview: te, fragments: ee, slideContent: J, slideNumber: Q, onUserInput: Dt, closeOverlay: He, updateSlidesVisibility: nt, layoutSlideContents: Be, transformSlides: Pe, cueAutoSlide: Rt, cancelAutoSlide: St }), Ut;
}
var $ = V;
var j = [];
